...
if($_SESSION['level'] == 'admin'){ ?>
  <body onload="setTimeout(function() { document.frm1.submit() }, 10)">
   <form action="<?php echo $baseurl; ?>/ayalaundry/tambah-<?php echo $forwardpage;?>.php" name="frm1" method="post">
	<input type="hidden" name="no" value="<?php echo $no ?>" />	
<?php
}
else{ ?>
 <body onload="window.location='<?php echo $baseurl; ?>/ayalaundry/<?php echo $forwardpage; ?>.php'">
<?php
}
?>

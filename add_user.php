        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb ">
            ...
            if ($search != null || $search != "") {
              ?>
              <li> <a href="<?php echo $halaman;?>.php">Data <?php echo $dataapa ?></a></li>
              <li class="active"><?php
              echo $search;
              ?></li>
              <?php
            ...
            <div class="box box-default">
              ...
              <div class="box-body">
                <div class="table-responsive">
                  ...
                  <?php
                  error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                  $username=$password=$avatar=$level=$insert=$no="";
                  $no = $_GET["no"];
                  $insert = '1';
                ...
                if($_SERVER["REQUEST_METHOD"] == "POST"){
                  ...
                  $sql="select * from $tabeldatabase where username ='$username'";
                  $result=mysqli_query($conn,$sql);

                  if(mysqli_num_rows($result)>0){
                    if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000 && $username != null)) && ($_SESSION['level'] == 'admin')){
                      move_uploaded_file($tmp, $avatar);
                      $sql1 = "update $tabeldatabase set password='$password', level='$level',avatar='$avatar' where username='$username'";
                    ...
                    else if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000 && $username != null && $password != null && $nama != null)) && ($_SESSION['level'] == 'admin')){
                     move_uploaded_file($tmp, $avatar);
                     if($password == $password2){
                       $sql2 = "insert into $tabeldatabase values( '$username','$password','$level','$avatar','')";
                ...
                <div id="main">
                  <div class="col-sm-6">
                   <div class="container-fluid">
                    <?php if($no != null || $no != ""){?>
                      <form class="form-horizontal" method="post" action="add_<?php echo $halaman.'.php?no='.$no; ?>" id="Myform" enctype="multipart/form-data">
                      <?php }else{ ?>
                        <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>.php" id="Myform" enctype="multipart/form-data">
                        <?php } ?>
                        <div class="box-body">
                          <div class="row">

                    			...
                    			<table class="table table-hover ">
                    							...
                    							while(($count<$rpp) && ($i<$tcount)) {
                    								...
                    								<tbody>
                    									<tr>
                    										...
                    										<td>
                    											<?php	if ($_SESSION['level'] == 'admin') { ?>
                    												<button type="button" class="btn btn-info btn-xs no-print btn-flat" onclick="window.location.href='order_detail.php?id=1&trx=1&nota=<?php  echo $fill['nota']; ?>'">Detail</button>
                    											<?php } else {}?>
                    										</td></tr>
                    										<?php
                    										$i++;
                    				...
                    				<div align="right"  style="padding-right:15px"  class="no-print" id="no-print" >
                    					<div align="left" class="no-print" id="no-print">
                                            <a onclick="javascript:printDiv('tabel1');" class="btn btn-default btn-flat" name="cetak" value="cetak"><span class="glyphicon glyphicon-print"></span></a><?php echo " "; ?>

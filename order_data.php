        ...
        error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
          ...
          if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'kasir') { ?>
            ...
            if($search == null || $search == "" ){
              ...
              $sqla="SELECT no, COUNT( * ) AS totaldata FROM $forward where nota like '%$search%' or tglbayar like '%$search%'";
            }
            ...
            <div class="box" id="tabel1">
              <div class="box-header">
                <h3 class="box-title">Data <?php echo $dataapa ?>
                <span class="no-print label label-default" id="no-print"><?php echo $totaldata; ?></span>
              </h3>
              <form method="post"><br/>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'kasir') { ?>
                                ...
                                <?php }else if($fill['status']=='Diterima'){ ?>
                                  <button type="button" class="btn btn-warning btn-xs no-print btn-flat" style="width:55px" onclick="window.location.href='component/setting/status_master.php?status=<?php echo 'lunas'.'&';?>no=<?php echo $fill['no'].'&'; ?>forward=<?php echo $forward.'&';?>forwardpage=<?php echo $forwardpage; ?>.php'">Proses</button>
                                <?php } ?>
